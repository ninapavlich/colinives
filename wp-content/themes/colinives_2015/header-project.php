...
<!--[if IE 7]>    <html <?php language_attributes(); ?> class="no-js ie7 lt-ie9 lt-ie8" lang="en"> <![endif]-->
<!--[if IE 8]>    <html <?php language_attributes(); ?> class="no-js ie8 lt-ie9" lang="en"> <![endif]-->
<!--[if IE 9]>    <html <?php language_attributes(); ?> class="no-js ie9 gte-ie9" lang="en"> <![endif]-->
<!--[if gt IE 9]>    <html <?php language_attributes(); ?> class="no-js gte-ie9" lang="en"> <![endif]-->
<!--[if !IE ]>    <html <?php language_attributes(); ?> class="no-js gte-ie9" lang="en" itemscope itemtype="http://schema.org/WebPage"> <![endif]-->
<html <?php language_attributes(); ?> class="no-js gte-ie9" lang="en" itemscope="" itemtype="http://schema.org/WebPage">
<head prefix="og: http://ogp.me/ns#">
    ...
    <title itemprop="name"><?= getPageTitle(); ?></title>
    <meta name="description" content="<?= getPageDescription(); ?>" itemprop="description">
    <meta name="author" content="Colin Ives" >

	 <!-- Dublin Core -->
    <meta name="dc.title" content="<?= getPageTitle(); ?>">
    <meta name="dc.creator" content="Colin Ives">
    <meta name="dc.description" content="<?= getPageDescription(); ?>">
    <meta name="dc.date.created" content="TODO" itemprop="dateCreated"><!-- TODO -->
    <meta name="dc.date.modified" content="TODO" itemprop="dateModified"><!-- TODO -->

    <!-- Facebook Open Graph -->
    <meta property="og:title" content="<?= getPageTitle(); ?>" />
    <meta property="og:description" content="<?= getPageDescription(); ?>" />
    <meta property="og:site_name" content="Colin Ives" />
    <meta property="og:image" content="<?= getPageImage() ?>" />
    <meta property="og:url" content="<?= getCanonicalURL() ?>" />
    <meta property="og:type" content="article" />
    <meta property="fb:admins" content="colin.ives.50" />


    <!-- Twitter Card -->
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:site:id" content="@TODO" />
    <meta name="twitter:title" content="<?= getPageTitle(); ?>" />
    <meta name="twitter:description" content="<?= getPageDescription(); ?>" />
    

    <!-- Schema.org markup for Google+ --> 
    <link rel="author" href=""/><!-- TODO -->
    <link rel="publisher" href=""/><!-- TODO -->
    ...
    <style>
    <?php include 'css/screen_combined.min.css'; ?>
    </style>
    ...
    <!--[if lt IE 9]>
        <link rel="stylesheet" href="<?= $theme_dir ?>/css/ie.min.css">
        
        <script src="//s3.amazonaws.com/nwapi/nwmatcher/nwmatcher-1.2.5-min.js"></script>
        <script src="//html5base.googlecode.com/svn-history/r38/trunk/js/selectivizr-1.0.3b.js"></script>

        <script src="<?= $theme_dir ?>/js/respond.min.js"></script>
        <script src="<?= $theme_dir ?>/js/html5.js"></script>
    <![endif]-->
